...
When you finish writing your post and click on Next, you will have the option to override the settigns for the title and subtitle both on the email and in the website post.

## Formatting Options (Right Panel)

To make your post look polished, you have full control over formatting:
...
- **Reset Styles**: If you want to revert your formatting changes back to the default, just click **Reset Styles** to start fresh.
